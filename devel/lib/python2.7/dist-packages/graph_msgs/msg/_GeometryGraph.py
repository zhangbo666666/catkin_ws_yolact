...
"""autogenerated by genpy from graph_msgs/GeometryGraph.msg. Do not edit."""
import codecs
import sys
...
class GeometryGraph(genpy.Message):
  _md5sum = "78739617daca94d38915923795eada2d"
  _type = "graph_msgs/GeometryGraph"
...
float64[] weights"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Point[]','graph_msgs/Edges[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GeometryGraph, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.edges:
        length = len(val1.node_ids)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.Struct(pattern).pack(*val1.node_ids))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.node_ids = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.edges:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(val1.node_ids.tostring())
        length = len(val1.weights)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.node_ids = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
