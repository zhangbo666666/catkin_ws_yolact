...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/zb/catkin_ws_yolact/src/image_pipeline-kinetic/image_proc)
  set(image_proc_DEVEL_PREFIX /home/zb/catkin_ws_yolact/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/zb/catkin_ws_yolact/install)
...
if(NOT "/home/zb/catkin_ws_yolact/devel/include;/home/zb/catkin_ws_yolact/src/image_pipeline-kinetic/image_proc/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/zb/catkin_ws_yolact/devel/include;/home/zb/catkin_ws_yolact/src/image_pipeline-kinetic/image_proc/include;/usr/local/include;/usr/local/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zb/catkin_ws_yolact/src/image_pipeline-kinetic/image_proc/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;/usr/local/lib/libopencv_calib3d.so.3.4.5;/usr/local/lib/libopencv_core.so.3.4.5;/usr/local/lib/libopencv_dnn.so.3.4.5;/usr/local/lib/libopencv_features2d.so.3.4.5;/usr/local/lib/libopencv_flann.so.3.4.5;/usr/local/lib/libopencv_highgui.so.3.4.5;/usr/local/lib/libopencv_imgcodecs.so.3.4.5;/usr/local/lib/libopencv_imgproc.so.3.4.5;/usr/local/lib/libopencv_ml.so.3.4.5;/usr/local/lib/libopencv_objdetect.so.3.4.5;/usr/local/lib/libopencv_photo.so.3.4.5;/usr/local/lib/libopencv_shape.so.3.4.5;/usr/local/lib/libopencv_stitching.so.3.4.5;/usr/local/lib/libopencv_superres.so.3.4.5;/usr/local/lib/libopencv_video.so.3.4.5;/usr/local/lib/libopencv_videoio.so.3.4.5;/usr/local/lib/libopencv_videostab.so.3.4.5;/usr/local/lib/libopencv_viz.so.3.4.5")
